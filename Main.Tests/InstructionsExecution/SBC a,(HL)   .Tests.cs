...
{
    public class SBC_A_aHL_tests : InstructionsExecutionTestsBase
    {
        private const byte SBC_A_aHL_opcode = 0x9E;

        [Test]
        public void SBC_A_aHL_substracts_value_from_memory_when_carry_is_reset()
        {
            var oldValue = Fixture.Create<byte>();
            var valueSubstracted = Fixture.Create<byte>();

            Setup(oldValue, valueSubstracted);
            Execute(SBC_A_aHL_opcode);

            Assert.AreEqual(oldValue.Sub(valueSubstracted), Registers.A);
        }

        [Test]
        public void SBC_A_aHL_substracts_value_plus_one_from_memory_when_carry_is_set()
        {
            var oldValue = Fixture.Create<byte>();
            var valueSubstracted = Fixture.Create<byte>();

            Setup(oldValue, valueSubstracted, cf: 1);
            Execute(SBC_A_aHL_opcode);

            Assert.AreEqual(oldValue.Sub(valueSubstracted + 1), Registers.A);
        }

        private void Setup(byte oldValue, byte valueToSub, int cf = 0)
        {
        ...
        [Test]
        public void SBC_A_aHL_sets_SF_appropriately()
        {
            Setup(0x02, 1);
        ...
        [Test]
        public void SBC_A_aHL_sets_ZF_appropriately()
        {
            Setup(0x03, 1);
        ...
        [Test]
        public void SBC_A_aHL_sets_HF_appropriately()
        {
        ...
        [Test]
        public void SBC_A_aHL_sets_PF_appropriately()
        {
        ...
        [Test]
        public void SBC_A_aHL_sets_NF()
        {
            AssertSetsFlags(SBC_A_aHL_opcode, null, "N");
        }

        [Test]
        public void SBC_A_aHL_sets_CF_appropriately()
        {
            Setup(0x01, 1);
        ...
        [Test]
        public void SBC_A_aHL_sets_bits_3_and_5_from_result()
        {
        ...
        [Test]
        public void SBC_A_aHL_returns_proper_T_states()
        {
            var states = Execute(SBC_A_aHL_opcode);
